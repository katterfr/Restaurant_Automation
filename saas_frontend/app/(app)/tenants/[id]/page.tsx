...
const FEATURE_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'staff_tools',     label: 'Staff Management',       desc: 'Clock-in, focus mode, and staff tools' },
      { key: 'automations',     label: 'Automations',            desc: 'Automated tasks and scheduling' },
      { key: 'goals',           label: 'Goals',                  desc: 'Performance goals and tracking' },
      { key: 'messaging',       label: 'Messaging',              desc: 'Team messaging and chat' },
    ],
  },
]
