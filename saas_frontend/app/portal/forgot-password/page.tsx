...
type Step = 'input' | 'sent-email' | 'sent-sms' | 'reset-sms' | 'done'
      ...
      <div className="w-full max-w-sm px-4">
        ...
        {step === 'input' && (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center">
              <Link href="/portal/login" className="text-sm text-gray-500 hover:text-gray-700">← Back to sign in</Link>
            </div>
          </form>
        )}
        ...
        {step === 'sent-email' && (
          <div className="text-center space-y-4">
            ...
            <Link href="/portal/login" className="block text-sm text-gray-500 hover:text-gray-700 mt-4">← Back to sign in</Link>
          </div>
        )}
        ...
        {step === 'done' && (
          <div className="text-center space-y-4">
            ...
            <Link href="/portal/login" className="block w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-full text-sm font-semibold text-center transition-colors">
              Sign in
            </Link>
          </div>
        )}
